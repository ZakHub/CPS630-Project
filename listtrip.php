    ...
    <div id="inner" class="floating">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr><td>".$row["id"]."</td><td>".$row["fromLat"]."<td>".$row["fromLng"]."</td><td>".$row["toLat"]."</td><td>".$row["toLng"]."</td><td>".$row["distance"]."</td><td>".$row["carId"]."</td><td>".$row["price"]."</td><td><a href=tripdelete?id={$row['id']}' >delete</a></td></tr>";
            }
        } else {
