    ...
    <div id="inner" class="floating">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr><td>".$row["id"]."</td><td>".$row["orderDate"]."</td><td>".$row["fulfillmentDate"]."</td><td>".$row["price"]."</td><td>".$row["userId"]."</td><td><a href='orderinfodelete.php?id={$row['id']}' >delete</a></td></tr>";
            }
        } else {
